...
},{"../models/GroceryModel":3,"backbone":6}],2:[function(require,module,exports){
...
},{"../collections/GroceryCollection":1,"../views/GroceryListView":4,"jquery":7}],3:[function(require,module,exports){
const Backbone = require('backbone');
...
const GroceryListView = Backbone.View.extend({
  ...
  render() {
    ...
    this.collection.forEach(item => {
      ...
      this.$el.find('ul').append(groceryView.render().el);
    });
    return this;
  }
});
...
},{"../models/GroceryModel":3,"./GroceryView":5,"backbone":6}],5:[function(require,module,exports){
